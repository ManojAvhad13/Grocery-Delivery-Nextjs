...
const AdminDashboardClient = ({ earning, stats, chartData }: propType) => {
    ...
    return (
        <div className='pt-28 w-[90%] md:w-[80%] mx-auto'>
            <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-10 text-clip
            sm:text-left'>
                <motion.h1
                ...
                <select className='border border-gray-300 rounded-lg px-4 py-2 text-sm focus:ring-2 focus:ring-green-500
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10'>
                {stats.map((s, i) => {
                    ...
                    const icons = [
                        <Package key="u" className='text-green-700 w-6 h-6' />,
                    ...
                    return <motion.div
                        ...
                        className='bg-white border border-gray-100 shadow-md rounded-2xl p-5 flex items-center gap-4
