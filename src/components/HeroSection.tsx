...
const HeroSection = () => {
    ...
    const slides = [
...

        {
            ...
            btnText: "Order Now",
            bg: "https://plus.unsplash.com/premium_photo-1661526833843-248a2f8fe129?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
...

        {
            ...
            btnText: "Get Started",
            bg: "https://plus.unsplash.com/premium_photo-1733342485605-42058eb2daf3?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        },
        ...
        <div className='relative w-[98%] mx-auto mt-32 h-[80vh] rounded-3xl overflow-hidden shadow-2xl'>
            ...
            <div className='absolute inset-0 flex items-center justify-center text-center text-white px-6'>
                ...
                >
                    ...
                    <button className='mt-4 bg-white text-green-700 hover:bg-green-100 px-8 py-3 rounded-full font-semibold
