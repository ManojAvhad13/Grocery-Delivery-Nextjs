...
const UserOrderCard = ({ order }: { order: IOrder }) => {
    ...
    return (
        <motion.div
            ...
            <div className='flex flex-col md:flex-row justify-between items-start md:items-center gap-3 border-b border-gray-100
                px-5 py-4 bg-gradient-to-t from-green-50 to-white'>
                <div>
